def pengelola_pengiriman_barang():
    barang_list = [] 
    while True:
        ...
        if prioritas == "1":  #
            ...
            if len(barang_list) == 0:
                ...
                for i in range(len(barang_list)):
                    ...
                    # Jika semua barang darurat, tambahkan di akhir
                    barang_list.append({'nama': nama_barang, 'id': id_barang, 'prioritas': prioritas})
...
#rombak ulang agar tidak membutuhkan 3 list agar tetap mengeluarkan output sesuai rules